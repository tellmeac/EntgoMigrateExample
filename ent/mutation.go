...
func (m *UserMutation) SetStars(i int) {
	m._Stars = &i
	m.add_Stars = nil
}

// Stars returns the value of the "Stars" field in the mutation.
func (m *UserMutation) Stars() (r int, exists bool) {
	v := m._Stars
	if v == nil {
		return
	}
...
func (m *UserMutation) OldStars(ctx context.Context) (v int, err error) {
...
func (m *UserMutation) AddStars(i int) {
	if m.add_Stars != nil {
		*m.add_Stars += i
	} else {
		m.add_Stars = &i
...
func (m *UserMutation) AddedStars() (r int, exists bool) {
	v := m.add_Stars
	if v == nil {
		return
	}
